    ...
    while True:
        ...
        if option == "1":
            ...
            if verificar_processo(nome_do_script):
                ...
                print("")
                print(f"  {cor_verde}https://api.cybercoari.app.br/checkuser.php?url=http://{ip}:{porta}/checkUser{cor_reset} ")
                print("")
                print(f" {cor_amarela}Link DtunnelMod abaixo :{cor_reset} ")
                print("")
                print(f"  {cor_verde}https://api.cybercoari.app.br/checkuser.php?url=http://{ip}:{porta}/dtmod{cor_reset}  ")
                print("")
                print(f" {cor_amarela}Link GltunnelMod abaixo :{cor_reset} ")
                print("")
                print(f"  {cor_verde}https://api.cybercoari.app.br/checkuser.php?url=http://{ip}:{porta}/gl{cor_reset} ")
                print("")
                print(f" {cor_amarela}Link AnyVpnMod abaixo :{cor_reset} ")
                print("")
                print(f"  {cor_verde}https://api.cybercoari.app.br/checkuser.php?url=http://{ip}:{porta}/anymod{cor_reset} ")
                print("")
                print(f" {cor_amarela}Link AtxTunnel abaixo :{cor_reset} ")
                print("")
                print(f"  {cor_verde}https://api.cybercoari.app.br/checkuser.php?url=http://{ip}:{porta}/atx{cor_reset} ")
                print("")
                input(f" {cor_vermelha} Pressione a tecla enter para voltar ao menu {cor_reset}")
            else:
